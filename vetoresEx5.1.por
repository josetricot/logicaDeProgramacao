...
5.1 Crie um algoritmo que leia um vetor de 9 posições de números maiores do que zero, imprima o vetor e informe:
...
programa {
    funcao inicio() {
        ...
        // Leitura dos valores com validação usando se/senao
        para (i = 0; i < 9; i++) {
            ...
            se (vet[i] <= 0) {
                ...
                i-- // Volta uma posição para repetir esta leitura
                continuar
            }
        ...
        // Exibição dos resultados (igual à versão anterior)
        escreva("\nValores informados:\n")
        para (i = 0; i < 9; i++) {
